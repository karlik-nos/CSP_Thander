void InitShips()
{
  ref refShip;
	...
	refship.SubSeaDependWeight			= 0.8;
	refship.TurnDependWeight			= 0.2;
	refship.WindAgainstSpeed   = 5.25;//boal
	refship.CabinType          = "New_Cabin1"; // boal 28.03.05
	refship.DeckType           			= "Low";
