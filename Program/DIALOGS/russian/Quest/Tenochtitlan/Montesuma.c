...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FT_1":
			...
			link.l1 = "Я знаю, что этот город - индейская столица. И что сам Кортес прошёлся здесь огнем и мечом.";
			link.l1.go = "FT_3";
		break;
		case "FT_3":
		...
		case "FT_24":
			...
			link.l1 = "Чёрт! А точней никак нельзя?";
			link.l1.go = "FT_25";
		break;
		case "FT_25":
		...
		break;
		case "Fire_3":
			dialog.text = "Да, воскрешенные Миктлантекутли ацтекские воины. Тебе придётся сражаться с ними. Внутрь храмов ты не сможешь взять помощников, так что все придётся делать только тебе.";
		...
		case "AfterGTemple":
			if (CheckCharacterItem(pchar, "SkullAztec")) //череп найден
			{
				...
				{
					link.l1 = "Не так быстро, приятель! Ты обещал мне какое-то мощное оружие. Я так ничего и не нашёл.";
