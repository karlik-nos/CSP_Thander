...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "AztecFT_1":
			dialog.text = "Мешитли.";
			link.l1 = "Ты здесь живешь, Мешитли? А кто ещё кроме тебя здесь есть?";
		...
		break;
		case "AztecFT_5":
			dialog.text = "Как обычно - кровь плененных тобой воинов. Приводи их сюда, а потом иди с ними в жертвенный храм. Ты долж"+ GetSexPhrase("ен","на") +" вырезать сердце война, пока он ещё жив, и кровью окропить жертвенный камень Миктлантекутли.";
