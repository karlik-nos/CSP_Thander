	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
			...
			if (npchar.quest.meeting == "0")
			{
				...
				link.l1 = "Спасибо за теплый прием, хотя моё прибытие оказалось несколько подмоченным!.. Меня зовут капитан " + GetFullName(pchar) + ".";
				link.l1.go = "FT_1";
			}
			else
			{
		...
		break;
		case "FT_6":
			dialog.text = "Вспоминать будете потом, сначала дослушайте... Так вот, Чад Каппер - глава Города. Должность эта выборная, так что он пришёл к власти, так сказать, демократическим путем. В его обязанности входит следить за исполнением Закона...";
		...
		case "FT_17":
			...
			link.l1 = "Хм, ну что же, понятно. Буду иметь в виду. Спасибо ещё раз за теплый прием.";
			link.l1.go = "FT_18";
		break;
		case "FT_18":
