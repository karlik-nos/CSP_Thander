...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FT_9":
			dialog.text = "Ясно. Значит, Тизер всё-таки сдержал данное мне обещание до конца, даже несмотря на угрозу своей жизни. Черт возьми, как жаль, что он погиб!";
			link.l1 = "Жаль, конечно. Вы знаете, столько хороших людей умерло за последнее время, что я уже устал"+ GetSexPhrase("","а") +" жалеть...";
			link.l1.go = "FT_10";
		break;
		case "FT_10":
			dialog.text = "Ну, не будем о грустном. Вы знаете, эта ваша Голландская компания права насчет ценностей Города. Тут чего только нет. А ещё больше - под водой...";
		...
		break;
		case "FT_30":
			dialog.text = "Ну вот, и вы туда же. Послушайте, я ученый, мракобесие мне чуждо... Да и вообще, я дам вам возможность спуститься по воду, а там денег ещё больше!";
		...
		break;
		case "FreeCorvett_1":
			dialog.text = "Я уже все подготовил. У меня на платформе стоит лебедка, к ней я прикрепил обломки вокруг фрегата. Так что стоит только привести механизм в действие - и вуаля, корабль свободен!";
		...
		case "FreeCorvett_7":
			...
			AddSimpleRumourCityTip("А я не верю, что этот Механик так важен для Города. Сколько жили без него, проживем и ещё...", "LostShipsCity", 10, 1, "LSC", "");		
		...
		break;
		case "DeepAgain_1":
			dialog.text = "Эти деньги - плата за корабль и за одно погружение. Я не обещал вам продать костюм, он остается у меня. Я сдаю его вам в аренду. Амортизация и все дела...";
		...
		break;
		case "FoundPinion_1":
			dialog.text = "Ну что же, теперь я могу заняться восстановлением механизма лебедки. Скажите, вы ещё будете совершать погружения?";
		...
		break;
		case "endImmersion_1":
			dialog.text = "Теперь, когда у меня есть все необходимое, я займусь восстановлением механизма лебедки, которая освободит ваш клиппер. Это займет у меня определенное время. Вам же пока не следует почивать на лаврах, а стоит провести ряд важных подготовительных мероприятий.";
		...
		//Набор команды
		case "TakeCrew":
			dialog.text = "Прекрасно, "+ GetSexPhrase("друг мой","дорогая моя") +", все уже размещено в трюме вашего клиппера. Теперь вам нужно набрать команду из жителей Города. Сами понимаете, вдвоем мы с фрегатом не управимся.";
		...
		break;
		case "inPrison_7":
			dialog.text = "Отправляйтесь ко второй мачте 'Фернадо Диффиндура', оттуда до корабля уже рукой подать. Я успел использовать лебедку до ареста и растащил корабли, окружающие клиппер. Теперь вы с легкостью оторветесь от Города.\nШторм набирает силу, боюсь, что сейчас вам придется нелегко... При выходе из 'Тартаруса', вы должны четко представлять себе, куда направиться - направо отсюда. Иначе в этом хаосе вы погибнете. Я ещё раз повторю, что вы должны двигаться по направлению ко второй мачте 'Фернандо Диффиндура'.";
			link.l1 = "Я понял"+ GetSexPhrase("","а") +", спасибо вам... Может быть, всё-таки попытаться открыть это чертову клетку?";
