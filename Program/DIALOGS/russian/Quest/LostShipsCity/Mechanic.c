...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "inPrison_7":
			dialog.text = "Отправляйтесь ко второй мачте 'Фернадо Диффиндура', оттуда до корабля уже рукой подать. Я успел использовать лебедку до ареста и растащил корабли, окружающие клиппер. Теперь вы с легкостью оторветесь от Города.\nШторм набирает силу, боюсь, что сейчас вам придётся нелегко... При выходе из 'Тартаруса', вы должны четко представлять себе, куда направиться - направо отсюда. Иначе в этом хаосе вы погибнете. Я ещё раз повторю, что вы должны двигаться по направлению ко второй мачте 'Фернандо Диффиндура'.";
