...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FT_7_1":
			dialog.text = "Пойдем дальше. Второе: запрещается строить корабли, плоты и прочие плавсредства. Выбраться отсюда всё равно невозможно, а разрушать Город нельзя.";
		...
		break;
		case "FT_12":
			dialog.text = "Не ты перв"+ GetSexPhrase("ый","ая") +", "+ GetSexPhrase("приятель","подруга") +", кому это не нравится. Но только, уж поверь мне, все это в твоих интересах. Чем быстрей ты избавишься от всего того, что тебя связывает с большим миром, тем быстрей ты вольешься в нашу размеренную жизнь.\nА так можешь сойти с ума, такое бывает. И, скажу я тебе, с такими мы не церемонимся - груз на шею, и на дно!";
		...
		case "DestrNarval_BadOk":
			dialog.text = "М-да, неприятно несколько... Ну да ладно, всё-таки это была резня, а не легкая прогулка по палубе. В общем, я рад, что все кончилось хорошо. Хочу подкинуть тебе деньжат за работу. Десять тысяч золотых!";
		...
		case "Interception_4":
		sld = characterFromId("Blaze");
			dialog.text = ""+ NPCharSexPhrase(sld, "","Вот это девка! ") +"Ну, то, что он"+ NPCharSexPhrase(sld, "","а") +" на тебя поработал"+ NPCharSexPhrase(sld, "","а") +" – это прекрасно. Но ты, надеюсь, не ввел "+ NPCharSexPhrase(sld, "его","её") +" в курс наших дел?";
		...
		break;
		case "Interception_5":
			dialog.text = "Кстати, о нашем деле. Уже много всего собрано, моим ребятам не терпится прокутить свою долю в борделях Карибского моря. Когда мы начнем приготовления к отплытию из этого чёртова места?";
		...
		break;
		case "BarmenDead_2":
			dialog.text = "Хм, хорошая мысль. Может быть, ты и сейчас пойдешь на место убийства и найдёшь что-нибудь эдакое, что укажет нам на преступника? Не желаешь?";
		...
		break;
		case "SeekCrew_3":
			dialog.text = "Ещё ты мне порассуждай о Городе! Механик - человек грамотный, но трус и паникер. Мы здесь столько штормов видели, что его теории уже просто смешны. Я говорил ему, чтобы он держал свои мысли при себе...";
