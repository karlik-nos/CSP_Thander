...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_3_1":
			dialog.text = "Кто штормы не любит, тому часто. А кому всё равно... ну, сам"+ GetSexPhrase("","а") +" понимаешь.";
		...
		break;
		case "SeekCrew_3":
			dialog.text = "Вот чёрт, я верю Механику... Ну что же, в таком случае, я согласен.";
