...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ELTHusb_begin_1":
			dialog.text = "Да шут его знает. Вообще-то, Максим - наш перманентный постоялец, но с Каппером он в первый раз связался. И очень зря, скажу я вам. Попав сюда, он ещё оч-чень хорошо отделался...";
		...
		case "ELTHusb_SF":
			dialog.text = NPCStringReactionRepeat("С этим вопросом я просил бы вас обратиться к адмиралу. Он его сюда посадил, он же пусть и принимает решение о его дальнейшей судьбе.",
				...
				"Ещё раз повторю, что мы уже говорили на эту тему.",
		...
		case "WineLogro":
			dialog.text = "Бутылочка вина от Доминика Легро?!\nВино я возьму, так уж и быть. Но этому проходимцу передай, я ещё с ним расквитаюсь!";
