...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "int_quests":
			...
			{
				link.l3 = "Скажите, вы давно уже живёте в Городе?";
		...
		break;
		case "ansewer_2_1":
			dialog.text = "Имеются, но я не считала. Вы знаете, здесь совершенно всё равно, какой вы нации. Это ровным счётом ни о чем не говорит и ни на что не влияет.";
			link.l1 = "Понятно...";
			link.l1.go = "int_quests";
		break;
		case "ansewer_2":
