...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_2_1":
			dialog.text = "Имеются, но я не считала. Вы знаете, здесь совершенно всё равно, какой вы нации. Это ровным счетом ни о чем не говорит и ни на что не влияет.";
			link.l1 = "Понятно...";
			link.l1.go = "int_quests";
		break;
		case "ansewer_2":
		...
		break;
		case "SeekGoods_1":
			dialog.text = "Ну, провианта и лекарств у меня нет. А вот ядер на корабле осталось довольно много ещё с тех времен, когда он ходил под парусом. А сколько вам нужно?";
