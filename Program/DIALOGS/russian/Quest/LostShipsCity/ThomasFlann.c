...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "ansewer_2":
			dialog.text = "Точно никто не знает. Вроде бы какое-то течение, очень сильное, как будто заворачивает все корабли сюда. Водоросли ещё...";
		...
		break;
		case "ansewer_2_4":
			dialog.text = "Понимаю, но придётся. А не сумеешь обтесаться здесь - с ума сойдешь. И тогда тебе конец по Закону!";
			link.l1 = "Чего?!";
