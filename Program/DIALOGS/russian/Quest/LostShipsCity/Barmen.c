...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "FS_2":
			dialog.text = "Это ничего не значит, когда речь идет о водах вокруг Города! Просто шторм пошёл на убыль, и именно это дало тебе шанс.";
			link.l1 = "Понятно...";
			link.l1.go = "exit";
		break;
		...
		break;
		case "TizerCellar_10":
			dialog.text = "Точно! Мы на верном пути!\nОтправляйся к 'Диффиндуру'. Полагаю, что там ты найдёшь предмет, к которому данный ключ и подойдет. Тизер, хоть и казался мне человеком с причудами, тем не менее был далеко не дурак, судя по всему...";
