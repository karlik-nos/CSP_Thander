...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "TizerCellarLate":
			dialog.text = "Это мне известно, ведь я ждал тебя там битый час! Чёрт возьми, нельзя же быть так"+ GetSexPhrase("им","ой") +" легкомысленн"+ GetSexPhrase("ым","ой") +" в таком серьёзном деле!";
