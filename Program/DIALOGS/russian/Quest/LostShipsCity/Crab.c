...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "crab_meat":
			...
			link.l1 = "Даже не знаю, смогу ли я как-то тебя утешить... Вот чёрт, теперь же совсем некому о тебе заботиться. Может быть ты голоден?";
			link.l1.go = "crab_meat_1";
		...
		case "crab_hire_1":
			...
			link.l1 = "Вот чёрт. Я тебя не понимаю, но надеюсь что ты меня сможешь. Ты вроде смышлёный и не такой злой, как твои сородичи. Не хочешь сбежать отсюда вместе со мной?";
