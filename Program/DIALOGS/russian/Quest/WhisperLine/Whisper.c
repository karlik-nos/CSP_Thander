void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "IncqGuard_bad_wheel":
			...
			dialog.text = "Вот и наша красавица\nЕсли я правильно помню инструкцию, тебя следует сначала привязать к колесу, после чего, медленными движениями вращать рычаг. Шипы внизу безнадежно искалечат и изуродуют твоё тело. Вряд ли после такого ты вообще сможешь ходить без чужой помощи\nТак... Ну и куда же подевалась верёвка?";
