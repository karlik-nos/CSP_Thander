	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
	 	...
	 	case "Gold_found_in_fort":    // Нода разговора в форте Куманы
            ...
            {
            	dialog.text = "Долго искать не пришлось, чёрт возьми! Мы нашли золото в этой комнате под досками, которыми устлан пол. Ты - настоящий корсар"+ GetSexPhrase("",", хоть и девушка") +".";
            }
        ...
        case "Step_F8_6":
            ...
            link.l1 = "Ну что же, я всё понял"+ GetSexPhrase("","а") +". Буду действовать, а ты пока ничего не предпринимай до моего возвращения.";
        ...
        case "Step_F8_Result":
			...
			{
				link.l1 = "Нет ещё... Но я работаю над этим, все будет...";
				link.l1.go = "exit";
			}
        break;
        case "Step_F8_8":
