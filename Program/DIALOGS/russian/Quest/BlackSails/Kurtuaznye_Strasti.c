...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "BS_KS_19":
            ...
            dialog.text = "Смилуйтесь! Ну ещё я слышал, что она клиентов не принимает, пираты её сильно за долги попользовали. Говорят команда самого Вейна... Ага, прям вся команда. Так что ищи другую, тут девок на любой вкус хватает. Только, пожалуйста, разносчицу не трогай. Племяшка моя.";
		...
		case "BS_KS_20":
            ...
            link.l1 = "Я хочу провести время с одной из твоих красоток. Кажется, мне приглянулась Максин.";
			link.l1.go = "BS_KS_21";
		break;
