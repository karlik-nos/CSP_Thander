void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Andre_Abel_Quest_In_Prison_Wrong_Way_1":
			dialog.text = "Напрасно ты так... Но, это твоё право... Уже завтра днем наши безжизненные тела будут посмешищем публике...";
		...
		case "Houm_3":
            dialog.text = "Чёрный лев выслушает, но будь "+ GetSexPhrase("краток, голландский наемник","кратка, голландская наемница") +".";
        	link.l1 = "Я не работаю на власти, чёрный пес. На голландском корабле, который ты утопил, был мой брат. И я хочу, чтобы ты ответил за его смерть.";
            link.l1.go = "Houm_4";
        break;
		...
		case "Halen_1":
			dialog.text = "Да, это моё имя, но вы так и не назвали мне свое? Потрудитесь объяснить, что вам угодно, или проваливайте прочь. Не стоит испытывать моё терпение - у меня нет ни малейшего желания тратить свое время на болтовню с чернью.";
