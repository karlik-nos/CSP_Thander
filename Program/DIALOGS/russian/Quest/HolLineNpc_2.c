...
//********************************* Диалоги кэпа, который увез де Барраса из Тортуги **********************************
		...
		break;
  		case "Step_H7_2":
			...
			link.l1 = "А-а-а, чёрт! Слушай, ты же пират, какого дьявола ты якшаешься с испанцами?!";
    	...
    	break;
		case "Step_H8_11":
			dialog.text = "А-а-а, вот как? Хорошо, это можно устроить. Книгу я продать не смог и, собственно, спрятал её в надежном месте. Предлагаю такие условия сделки: вы платите мне 235 тысяч, и я даю вам карту того места, где лежит книга.";
