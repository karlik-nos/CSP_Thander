...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
 		...
 		case "Step_13":
        	dialog.text = "Слушай, ежели желаешь, заскочи ко мне через месяц-другой. Может, ещё работенка подвернется.";
		...
		break;
 		...
 		case "Step_15":
        	dialog.text = "Проблема следующая. Испанцы, вот уже сотню лет безжалостно истребляющие континентальных индейцев и уничтожающие их культурное наследие, вдруг озаботились сбором предметов этой самой индейской культуры.\n"+
                          ...
                          "И ещё, так, между прочим... Я хочу получить инвентарную опись собранного испанцами индейского добра. Де ла Фонтену будет очень интересно на нее взглянуть.";
		...
		break;
 		...
 		case "Step_36":
        	dialog.text = "Хм, даже не знаю, что сказать.\n"+
                          "Может и никакой гробницы и нет, не знаю... Но все же, если тебе улыбнется удача и ты что-либо найдёшь - буду рад тебя видеть.";
		...
		break;
 		...
 		case "AfterAttackMummy":
            ...
            if (GetCharacterIndex("LeifEricson") == -1)
            {
            	...
            	link.l1 = "Да всё в порядке, мир спасен, люди могут спать спокойно.";
        		link.l1.go = "Step_60";
		...
		break;
 		...
 		case "Step_58":
        	dialog.text = "Посильней, не спорю. Я лихо с оглоблей управляюсь, а вот шпага - это не моё.\n"+
                          "Ты про пещеру говорил"+ GetSexPhrase("","а") +", там придётся идти. И как я буду в стесненном пространстве оглоблей-то махать? Не выйдет у меня.";
		...
		break;
 		...
 		case "Step_71":
        	dialog.text = "С тебя я денег не возьму. Мы ведь с де ла Фонтеном должны тебе ещё, сколько ты сделал"+ GetSexPhrase("","а") +" для нас, ожидая награды. Будем считать, что мы в расчете. А черепа забирай.";
