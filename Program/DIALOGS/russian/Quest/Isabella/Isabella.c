...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		case "BrigAbordage_2":
			...
			{
				link.l1 = "Мне не к чему оправдываться, ибо я сам видел, как Сальватор зарезал вашего брата. Ваш брат выяснил, что именно Сальватор подделал векселя, убившие вашего отца. Дон Мигель собирался доложить об этом губернатору и тогда Сальватор убил его. Он пытался убить и меня, чтобы сокрыть свое преступление. Вы всё равно бы мне не поверили, и я решил покинуть город на время.";
		...
		case "IsabellaInCave":
            ...
            link.l1 = "Изабелла, вы живы! Слава Господу! В джунглях я нашёл мертвую девушку, по всей видимости, это служанка, с которой вчера вы покинули дом Роситы.";
		...
		case "NewLife_firstTime":
			...
			{
				dialog.text = "Ах, дорогой, как хорошо, что ты наконец-то пришёл домой! Уладил все вопросы с происшествием в церкви?";
				link.l1 = "Да, дорогая, я был на приеме у губернатора. Всё в порядке - он нас поздравляет.";
			}
