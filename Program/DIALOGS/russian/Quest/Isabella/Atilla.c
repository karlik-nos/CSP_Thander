...
void ProcessDialogEvent()
{
	...
	if (PChar.sex != "woman")
	{
		...
		link.l1 = "Атилла! Здорово, старый морской чёрт!";
		link.l1.go = "port_1";
	}
	else
	{
	...
	case "CitizenNotBlade":
		...
		case "Tavern_1":
			...
			dialog.text = "Чёрт возьми, "+GetFullName(PChar)+"! Славное дельце мы с тобой провернули тогда в Каракасе, разрази меня гром!";
		...
		case "Tavern_5":
			dialog.text = "Время идёт, да и я старею. Не так просто мне уже отправить человека на тот свет...  А Сальватор, говорят, на мои денежки свадебку сыграл. Живет теперь в Сан-Хуане...";
			link.l1 = "Чёрт меня побери!  Атилла, дружище, а не навестить ли мне это тихое семейное гнездышко? Глядишь, в жениной шкатулке твои побрякушки отыщутся, а?";
			link.l1.go = "Tavern_6";
		break;

		case "Tavern_6":
			dialog.text = "Ха-ха-ха! Сдается мне, ты не ради побрякушек в её спальню пробраться надумал!  Да нет, приятель, раз уплыла добыча из моих рук - видно, так тому и быть... Ну, пора мне. Даст Бог - ещё свидимся.";
		...
		break;
		case "TalkingNews_8":
			dialog.text = "У-у-у, приятель, а тебе не всё равно?";
		...
		break;
		case "TalkingNews_10":
			dialog.text = "Это французский... Ничего, всё в порядке..\n"+
		...
		case "AtillaInHouse_3":
			...
			link.l1 = "И зачем она ему? Он уже разорил её...";
		...
		break;
		case "SalvatorNews_1":
			dialog.text = "У меня всё в порядке. Как у тебя дела двигаются?";
		...
		case "IsabellaIsDead_1":
			...
			link.l1 = "Я убил Сальватора и мы должны были обвенчаться с Изабеллой в Сан-Хуане. На церемонии в церковь воралась толпа головорезов, и они убили её... Их нанял Сальватор, когда был ещё жив.";
		...
		break;
		case "AddRepa_4":
			dialog.text = "Эх, чёрт меня дери!! Это ж какие деньжищи!\n"+
