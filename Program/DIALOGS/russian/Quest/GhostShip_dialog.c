...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
        ...
        case "Meeting_1":
			dialog.text = "Моя ошибся? Ты белый человек, я белый, мое имя даже 'Белый Мальчик'. Одежда - память о предках, я носить её, как смочь одеть, давно.";
		...
		case "GhostCapt_4":
			dialog.Text = "Осталось мало, они уже почти все потратить, я собрать все, что было, осталось совсем мало, нужно 666 чёрных жемчужин с их корабля. Тогда проклятие обернется правильной стороной.";
		...
		case "quest_coin_2":
            dialog.Text = "Замечательно. Ты спасти всех нас! Скорее давай их. Тебе остается только ещё раз встретить корабль и сломать его или взять боем. На этом их пути конец. Теперь они стать просто пираты, без чёрного паруса.";
