...
// ============================================================================
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "First time":
    		...
    		link.l1 = "Да, платье в самый раз... Я же только что был"+ GetSexPhrase("","а") +" на верфи " + XI_ConvertString("Colony"+pchar.questTemp.Ascold.ShipyarderColony+"Gen") + "!!! Как я сюда попал"+ GetSexPhrase("","а") +"?! Чёрт возьми, что происходит?!!";
    		link.l1.go = "Step_1";
		break;

		case "Step_1":
        	dialog.text = "Не надо так волноваться.\n"+
                          "Во-первых, я не банальный чёрт, а демон! Взял тебя на время, сейчас поговорим и верну на место.\n"+
                          "А во-вторых, спасибо, что всё-таки вскрыл"+ GetSexPhrase("","а") +" лампу.";
    		link.l1 = "Что?! Опять?!!!";
    		link.l1.go = "Step_2";
		break;
		...
		case "Step_5":
        	dialog.text = "Да нет проблем. Я к тебе испытываю определенное чувство благодарности, ты ведь вскрыл"+ GetSexPhrase("","а") +" эту жестянку и не отдал"+ GetSexPhrase("","а") +" её церкви.\n"+
                          ...
                          "А у тольтеков Лейф нашёл действенный ритуал вызова демонов. Он привел ритуал в действие и, к несчастью, вызвал именно меня.";
		...
		case "Step_7":
        	dialog.text = "Точно. В такие жестянки помещают восточных демонов-рабов - джиннов. Лейф использовал лампу джинна для заточения меня.\n"+
                          ...
                          "В общем, с похмелья даже и не увидел, куда лезу. Вот так и попался. А Лейф после моего заточения отправил письмо своим родственникам, где описал ритуал своего воскрешения. Это письмо и нашёл француз де ла Фонтен, а ты привел"+ GetSexPhrase("","а") +" ритуал в действие.";
		...
		case "Step_10":
        	dialog.text = "Мне тоже. Учитывая то, что результатом знакомства стало моё освобождение, мне приятно вдвойне.\n"+
                          "Однако, теперь ты знаешь моё имя и можешь провести ритуал моего вызова. Надеюсь, ты не станешь дергать меня по поводу и без повода.\n"+
                          "Я, знаешь ли, очень этого не люблю. Так попадешь не в настроение, и моё хорошее отношение к тебе вмиг испарится. А в гневе я страшен...";
		...
		case "Step_27":
        	dialog.text = "Откуда мне знать, зачем тебе это? Ты захотел"+ GetSexPhrase("","а") +" быть губернатором - я тебя им сделал.\n"+
                          ...
                          "Мне придётся смоделировать целую цепь событий, которая привела тебя к креслу губернатора. Соответственно, события окружающего мира и людей вокруг тоже будут изменены. К чему это приведет в итоге - не смогу точно сказать даже я.\n"+
		...
		case "Step_35":
    		...
    		link.l1.go = "Step_36";
    		link.l2 = "Нет, не соглас"+ GetSexPhrase("ен","на") +". Пусть все остается, как есть. Давай лучше посмотрим, что у тебя ещё есть в плане исполнения моих желаний.";
    		link.l2.go = "Wishes";
		break;
		...
		case "Step_47":
        	dialog.text = "Хм, с каким чувством сказано! Ну ладно, всё в порядке - ты теперь опять уязвим"+ GetSexPhrase("","а") +". Контракт расторгнут.";
		...
		case "ClimeUsurer":
			...
			link.l1 = "Аззи, чёрт возьми, как я рад"+ GetSexPhrase("","а") +" тебя видеть!!!";
