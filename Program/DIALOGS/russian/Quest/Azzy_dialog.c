	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Step_7":
        	dialog.text = "Точно. В такие жестянки помещают восточных демонов-рабов - джиннов. Лейф использовал лампу джинна для заточения меня.\n"+
                          ...
                          "В общем, с похмелья даже и не увидел, куда лезу. Вот так и попался. А Лейф после моего заточения отправил письмо своим родственникам, где описал ритуал своего воскрешения. Это письмо и нашёл француз де ла Фонтен, а ты прив"+ GetSexPhrase("ёл","ела") +" ритуал в действие.";
