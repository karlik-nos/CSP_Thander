...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "PQ5CapGoodlyEnd_1":
			dialog.text = "Ха! Ты несказанно меня обрадовал"+ GetSexPhrase("","а") +"! Гора с плеч свалилась.\nИзвини, всю сумму ещё не собрал, пока только 15 тысяч, остальные заплачу чуть позже... Будь уверен"+ GetSexPhrase("","а") +", не обману, мне не нужен враг в твоем лице.";
		...
		case "PQ8_PirInPan":
			dialog.text = "Знаешь, " + pchar.name + ", не зря я пошел к тебе в команду. В итоге я жив, да ещё в захваченной Панаме! Кто бы мог подумать?..";
