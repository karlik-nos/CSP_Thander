...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "LSCQuestMent_2":
			...
			link.l1 = "Так он ещё не знает? Да ведь это же прекрасно!.. Хм, боюсь, тебе придется умереть.";
		...
		case "SCQ_RapeWife":
			dialog.text = "Мое относительное бездействие привело к печальным результатам. Этот мерзавец похитил мою жену и увез её на своем корабле в море. Я прошу вас найти этого негодяя!";
