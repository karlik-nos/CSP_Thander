...
//********************************* Дилоги лейтенанта в тюрьме. Квест №3 **********************************
		...
		break;
 		case "Step_H3_3":
			...
			link.l1 = "Чёрт возьми, все указывало именно на это! Я держу свое слово: ты свободен и можешь идти куда угодно. Прощай.";
...
//********************************* Базар с незнакомцем на Тортуге. Квест №7 **********************************
		...
		break;
        case "Step_H7_10":
			dialog.text = "Боюсь, что в данном конкретном случае моё желание в учет принято не будет...";
