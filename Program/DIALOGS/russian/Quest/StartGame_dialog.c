...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Advice_9":
			dialog.text = "Ещё можно поднять на корабле враждебный флаг, если он у вас есть, и уповать на свою удачу и скрытность. Ну, а самый надежный способ благополучно проникнуть во вражеский город - купить лицензию национальной торговой компании, в этом случае вас никто не задержит. Однако, не забудь флаг на корабле поднять соответствующий. Сами понимаете, глупо пытаться предъявить испанскую лицензию, если флаг на мачте - английский.";
			link.l1     = "Дальше.";
		...
		case "Teach_5":
			dialog.text = "Оружие у всех разное, делится по весу на легкое, среднее и тяжёлое. Вес оружия определяет расход энергии. Легеньким кинжалом можно без устали орудовать, зато тяжелым топором можно одним круговым ударом нескольких противников за раз на тот свет отправить.";
			link.l1     = "Дальше.";
			link.l1.go  = "Teach_6";
		break;
		...
		case "Teach_battle_lose":
			...
			dialog.text = LinkRandPhrase("Да-а... Что-то совсем вы ослабели. Будьте внимательнее, больше блокируйте и парируйте. Пробивной не зевайте - от него блок не спасает, используйте финт, парирование или отскок.",
										 ...
										 "Если энергия иссякнет - убегайте или отпрыгивайте, а противника доставайте финтом. Учтите, финтом удар так просто не отбить, но можно противника обмануть. И уж если попадётся он на вашу уловку, да попытается на ваш обманный замах ударом ответить - тут вы не только его клинок от себя отведете, но и сами ему нанесёте урон.") +
										 " Ну что, ещё раз?";
		...
		case "Teach_battle_win_2":
			...
			if (pchar.name == "Джессика")
			{
				dialog.text = "Прекрасно, капитан! Уроки Белтропа не прошли бесследно, всё же он неплохо вас обучил. И последний совет: чем больше вы фехтуете оружием одного типа, тем больше растет ваше умение. Хотите восстановить мастерство владения всеми видами - чаще меняйте тип оружия.";
			}
			else
			{
