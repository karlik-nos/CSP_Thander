	...
	switch(Dialog.CurrentNode)
	{
	 	...
	 	case "I_want_attack":    // Идем на испанцев, а может и не идем
            if (GetCompanionQuantity(pchar) == 1)   // Заставляем геймера избавиться от взятых кубиков.
            {
           		dialog.text = "Ну что ж, атакуемый город - Белиз. Мне донесли, что сейчас там собрано много золота с испанских золотых шахт на американском континенте. Золото готовится к отправке в Европу, нам нельзя медлить.\n"+
                              ...
                              "И ещё один важный момент - если ты будешь штурмовать форт и тебе улыбнется удача, то знай, что команды наших кораблей поддержат тебя при штурме.\n"+
        ...
        break;
 	 	case "Step_H3_6":
            ...
            {
                dialog.text = "Понятно. Но это ещё ничего не доказывает точно. Я знаю, что такие суммы у него есть в наличии. Так что вам придется вернуться на Тортугу и продолжить сбор информации.";
		...
		case "PL_Q5_afterFight_1":
			dialog.text = "Буду откровенен: я НЕ знаю, что было бы, не проведи я расследование. Ладно, не расстраивайся. Ты всё равно врать не умеешь. Это даже идиоту понятно.\n Да, это ещё не все, отправляйся к Джекмену. У него там случилась какая-то неприятность, в которой снова фигурирует твое имя. Заодно расскажешь о сегодняшнем событии. Похоже, что это звенья одной цепи.";
		...
		case "PL_Q8_PBResidence_8":
			dialog.text = "Это ещё не все. Джекмен и Моррис пойдут со мной. Ты пойдешь с Соукинсом. Испанцы знают о нашем походе, и наверняка попытаются организовать засаду в джунглях. А скорее всего, и не одну.";
		...
		case "PL_Q8_afterPanama_5":
			dialog.text = "Да. Я оказал огромную услугу английской короне - здорово сократил количество пиратов в Карибском море, да ещё и принес в английскую казну такие деньги!";
