...
/*
    ...
    */
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "CGStep_2":
        	dialog.text = "Ах, так я ещё должен заботиться о здоровье мятежников! Черт побери! Вы думаете, что мы будем его лечить? Вдоль всей дороги от Вестона до Бриджуотера расставлены виселицы, и он подойдет для любой из них. Полковник Кирк научит этих дураков-протестантов кое-чему такому, о чем будут помнить их дети, внуки и правнуки!";
