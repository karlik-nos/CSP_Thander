	...
	switch(Dialog.CurrentNode)
	{
		...
		case "FoundLiz":
			...
			link.l1 = HeroStringReactionRepeat("Элизабет не знает, как и почему было наложено это проклятие. Но ей стало известно, как его снять.",
				"Да, я помню.",
                "Да, конечно...",
				"Я так"+ GetSexPhrase("ой","ая") +", настойчив"+ GetSexPhrase("ый","ая") +". Вот думаю, буду одно и то же спрашивать - авось случится чудо! Заклятие спадет, или ещё чего-нибудь...", npchar, Dialog.CurrentNode);
		...
		break;
		case "DMSkelHead_3":
			dialog.text = "Да вот то, что видите. Днем все люди, как люди, а как солнце сядет - такой вот маскарад. Сообразили, что все из-за пиратов этих, будь они прокляты! И хоть они тоже по ночам скелетами оборачивались, но всё равно - всех, кто у нас оставался, в одну прекрасную ночь на костер отправили. Не помогло...";
		...
		break;
		case "DMSkelHead_10":
			dialog.text = "Она пыталась в подробностях выяснить, что произошло той ночью среди пиратов. Я спрашивал у нее, зачем ей это нужно, но она оказалась штучкой ещё той! Ничего не сказала.";
