...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Next_9":
            dialog.text = "Ха! Это вы! Вы шпион! Вы хотите украсть секрет моего гениального изобретения - я ничего вам не буду рассказывать!";
		...
		case "Ja_1":
			sld = CharacterFromID("Charles_shipyarder");
            dialog.text = "Спасибо вам, "+ GetSexPhrase("герр","фройлен") +" "+pchar.name+". Вы дали мне шанс вырваться из этого средоточия интриг, и я вам очень признателен.\n"+
