...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Novaya_Babushka":
			...
			if (Phrase == 3)
            {
				dialog.text = "Видела я сон, сон вещий! Не смейся! Уважай старость. Так вот. Во сне губернатор французский с самого короля Солнце обещал копию снять и будет на нём барон. Эмм... Как же барона того звать? Будет на самом короле гладь морскую рассекать!";
				link.l1 = "";
				link.l1.go = "exit";
				NextDiag.TempNode = "Novaya_Babushka";
			break;
