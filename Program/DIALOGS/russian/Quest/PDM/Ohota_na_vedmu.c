...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "RazgovorSGuberom_6":
			...
			link.l1 = "Надеюсь, сеньор генерал-губернатор, эту загадку можно разрешить. Но у меня есть важные дела, и если вы мне позволите, то я пойду.";
