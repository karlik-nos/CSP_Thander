...
//*********************************** Диалоги Джиллиан Эттербери *************************************
        ...
        case "Step_E6_27":
			dialog.text = "Мы задолжали ростовщику деньги и не выплатили долг вовремя. Тогда он пришёл к нам домой и заявил мужу, что бросит его в тюрьму, если в течение недели мы не вернем долг с процентами.\n"+
