void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "ATpr_SD_Koten_7":
			...
			link.l1 = "Да, это не плохая идея - начать с фрахта. Рыбачить в окрестных водах точно не для меня. Ладно, сеньор Котес, позже о наших планах на будущее, сегодня ещё нужно успеть в резиденцию.";
