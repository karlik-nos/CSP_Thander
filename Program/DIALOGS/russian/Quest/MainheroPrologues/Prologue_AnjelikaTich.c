void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "Rebekka_v_komnate_2":
			...
			link.l1 = "Я была в порту, там корабль из Гаваны. Военный... Прибыл новый комендант, которого назначили на место нашего отца. Мне удалось с ним поговорить и описать со всей прямотой то не простое положение, в котором мы оказались.";
		...
		case "Rebekka_v_komnate_4":
			...
			link.l1 = "На корабле достаточно кандидатур. Знатные молодые офицеры присутствуют и при параде! Парочка из сошедших с первой шлюпки очень даже не дурны собой. Пойдём, обозначим своё присутствие, пока они не попрятались в свои казарменные норы от полуденной жары.";
		...
		case "Sofia_6":
			...
			link.l1 = "Мои детство и юность небыли спокойными, я бы, наверное, отнеслась к подобным событиям как к приключению, а вам должно быть тяжело, оторваться от размеренной жизни и оказаться в такой пучине из неприятностей. Но кажется удача всё же вам улыбнулась, мы сможем друг другу помочь.";
			link.l1.go = "Sofia_7";
		break;
		...
		case "Rebekka_v_grote_2":
			...
			link.l1 = "Значит ты время от времени за мной приглядываешь. Послушай, я не могу, следуя твоему примеру, торчать целый день взаперти, а от нашего форта меня тошнит. Я устала ловить на себе эти взгляды местных солдафонов, выслушивать их примитивные комплименты и шуточки.";
		...
		case "Rebekka_v_grote_5":
			dialog.text = "И спрятала, то что в них нашла здесь, чтобы никто не нашёл и не подумал, будто это ты его заколола?";
			link.l1 = "Ну конечно.";
		...
		case "Rebekka_v_grote_8":
			...
			link.l1 = "Нет, орудия форта я узнаю, кажется звук с моря. Пойдём быстрее!";
		...
		case "Stoim_na_pirse_2":
			dialog.text = "Пираты. Весь гарнизон выбит, кому-то удалось убежать в джунгли, или как мне, отсидеться в укрытии, но здесь уже никого не осталось, последние переправились вон на тот барк.";
		...
		case "Stoim_na_pirse_4":
			dialog.text = "Я не знаю их мотивов, но послушай, ты ведь разбираешься в морской навигации? На барке остались несколько матросов, они конечно могут провезти корабль вдоль берега, но капитан и штурман были в городе, и их не пощадили, а нам нужен оптимальный маршрут, чтоб избежать рифов, мелей. Мы должны успеть в Санто-Доминго раньше пиратов.";
		...
		case "Stoim_na_pirse_6":
			dialog.text = "Мы тоже не можем ждать, дело даже не в том, чтобы успеть предупредить губернатора о нападении, у нас под боком стоят вражеские корабли и на них ещё остались люди, которые могут высадится сюда в любой момент.";
		...
		case "AT_pr_Officer_u_rezidenta_3":
			dialog.text = "Это что, ваше первое поручение в качестве посла? Адмиралтейство, вон то большое, серое здание, на которое я обречён смотреть целыми днями. Пройдите в его арку и поверните направо. Там ещё банк, прямо напротив нужной вам двери.";
			link.l1 = "Благодарю.";
		...
		case "ATpr_SD_Gubernator_2":
			...
			link.l1 = "Я одна из немногих выживших колонии Ла-Вега. Нас атаковали буканьеры, сначала обстреляли форт с моря, потом высадились на берег и устроили там резню.";
		...
		case "ATpr_SD_Gubernator_4":
			dialog.text = "Мне вы так и не представились, впрочем, это не существенно. Кто-нибудь из выживших общался с этими пиратами? Какие требования они выдвигают?";
			link.l1 = "Насколько мне известно, никаких. Часть команды пиратов осталась в гавани на кораблях, а часть отправилась в поход через джунгли. Они идут сюда, и раз уж мы здесь спокойно разговариваем, а в городе всё спокойно, значит мы успели обогнуть остров по воде раньше них.";
		...
		case "ATpr_SD_Koten_1":
			dialog.text = "Вот ты где! Вижу всё позади, а я уже пол города оббегал и как только услышал звуки выстрелов, сразу понял, где тебя искать.";
		...
		case "ATpr_SD_Koten_3":
			dialog.text = "Ещё не всё потеряно. Послушай, команда на корабле организовали совет. Решали, стоит ли нам оставаться здесь, или попытать удачу и вернуться в Ла-Вегу, и заодно предложили выбрать общим голосованием себе капитана.";
		...
		case "ATpr_SD_Koten_7":
			dialog.text = "Мы теперь в одной лодке. Что бы не выплатил губернатор, сейчас то я тоже остался без гроша в кармане, но коммерческая жилка, это тебе не лоток на площади, её так просто залпом с борта из меня не выбить, а уж имея корабль вместе мы не пропадём.";
			link.l1 = "Да, это не плохая идея - начать с фрахта. Рыбачить в окрестных водах точно не для меня. Ладно, мистер Котес, позже о наших планах на будущее, сегодня ещё нужно успеть в резиденцию.";
		...
		case "Pirat_Guber_5":
			dialog.text = "Можешь взять своих ребят и прочесать остров, но я бы заключил пари, если они живы, придут сами, а можешь раздать лопаты и отдать приказ проверить могильник за городом. У меня ты их не найдёшь.";
			link.l1 = "Награду за мёртвых никто не назначал.";
