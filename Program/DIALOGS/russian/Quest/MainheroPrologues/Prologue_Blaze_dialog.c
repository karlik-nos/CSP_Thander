...
//grotto - dialog 2
		...
		case "7":
			...
			link.l1 = "Она самая. К твоим услугам, дорогой братец. Жаль, что нам случилось встретиться благодаря такому дурацкому совпадению, но я всё равно рада тебя видеть.";
			link.l1.go = "8";
