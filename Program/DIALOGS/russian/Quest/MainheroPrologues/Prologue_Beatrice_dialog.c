...
//grotto - dialog 2
		...
		case "5":
			...
			dialog.text = "А ты крепкий чёрт. Почему ты остановился? Давай, покончим с этим!";
		...
		case "7":
			...
			link.l1 = "Он самый. К твоим услугам, дражайшая сестрица. Жаль, что нам случилось встретиться благодаря такому дурацкому совпадению, но я всё равно рад тебя видеть.";
			link.l1.go = "8";
		...
		case "9":
			...
			link.l1.go = "10";
			link.l2 = "Эти деньги, как и все остальные в этом мире, предназначены моему кошельку. Все, кто считает иначе или убираются с моей дороги, или умирают. Поскольку ты вряд ли уберешься с дороги, придётся тебя убить.";
			link.l2.go = "Exit kill";
		break;
