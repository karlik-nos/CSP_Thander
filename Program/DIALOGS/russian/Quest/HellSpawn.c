void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		case "First time":
            ...
            link.l1 = "А ты ещё откуда взялся?";
            link.l1.go = "HS_1";
			link.l2 = "Это не твоё дело. Не мешай мне.";
            link.l2.go = "HS_2";
		...
		case "Ritual":
			dialog.text = "Зачем ты пришёл сюда? Хочешь прервать наш ритуал перерождения?";
		...
		case "Ritual_1":
			dialog.text = "Многие ждут своей очереди сотни лет. Ты ещё не достоин.";
