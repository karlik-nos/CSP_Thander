...
//<<<<<<<<<<<<======== Разброс диалогов по персонажам ======================
		...
		break;
 		case "Step_2":
    		...
    		link.l1 = "Есть одна проблема. Некоторое время назад из Гаваны ушёл мановар, под завязку гружённый предметами индейского культа.";
    		link.l1.go = "Step_3";
		break;
 		case "Step_3":
		...
		break;
 		case "Step_4":
    		...
    		link.l1 = "Я понимаю. Единственное, что мне нужно знать, это куда ушёл мановар.";
    		link.l1.go = "Step_5";
		break;
 		case "Step_5":
        	dialog.text = "Он ушёл к бухте Аматике, что южней Белиза. По пути должен сделать остановку у острова Кайман.";
    		link.l1 = "Вот это да! Странное место... И что, так и ушёл один?";
    		link.l1.go = "Step_6";
		break;
 		case "Step_6":
        	dialog.text = "Да, ушёл один. Дело в том, что Кайман - место сбора и других кораблей с испанских колоний в Америке. Представляешь, в Аматике, дальше вглубь Мейна нашли заброшенный индейский храм, и сейчас там работает королевская экcпедиция. А уж после того, как экспедиция закончит работу, эскадра должна идти в Старый Свет.\n"+
                          "Это все, что я знаю.";
