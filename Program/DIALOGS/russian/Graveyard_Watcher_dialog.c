...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "UndeadObuchenie_3":
			...
			link.l1 = "Это не приятно. Но... А есть ли у меня союзники?",
			link.l1.go = "UndeadObuchenie_13";
		break;
		
		case "UndeadObuchenie_11":
			dialog.text = "Хе-хе, нет! К таким как ты я привык. Даже поддерживаю хорошие отношения с некоторой нежитью. Но я - исключение из правил. Но тебе нужно быть осторожнее, так как остальные жители этого острова будут тебя бояться и... будут пытаться уничтожить тебя.";
			link.l1 = "Это не приятно... Но тогда что мне делать?",
