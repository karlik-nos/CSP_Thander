    ...
    switch (Dialog.CurrentNode)
	{
        ...
        case "Step_E6_2":
			dialog.text = "Мне сложно говорить о людях плохо.\n"+
                          "Я бы посоветовал тебе обратиться к одной нашей прихожанке Джиллиан Эттербери. Мне известно, что у нее серьезные проблемы как раз с этим человеком. Возможно, вы сможете ей даже в чём-то помочь.\n"+
