						...
						if (sti(rColony.HeroOwn)) // наш горожанин
						{
			         		switch (rand(10))
							{
								...
								case 4:
									...
									link.l1 = "Ты прав, корсар: твое дело - стоять на посту и следить за порядком. Ну а вздёрнуть губернатора на нок рее - это уже занятие для меня. Молодец!";
									link.l1.go = "exit";
								break;
