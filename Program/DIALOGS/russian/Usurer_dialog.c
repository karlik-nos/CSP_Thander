...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case "CapBloodUsurer_5":
			...
			link.l1 = "Вы хотите, чтобы я нашел этого человека? Почему вы думаете, что он ещё в городе?";
		...
		case "Takeslaves_4_lose":
			...
			link.l1 = "Вы правы, черт возьми... Я... ну, это... опоздал"+ GetSexPhrase("","а") +" к острову. Он, видимо, уже ушел оттуда, так как я никого не наш"+ GetSexPhrase("ёл","ла") +". Весь путь пришлось идти в бейдевинд - постоянно дул встречный ветер, будь он неладен...";
