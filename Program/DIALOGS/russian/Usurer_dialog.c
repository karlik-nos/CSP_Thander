...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case "Takeslaves_4_lose":
			...
			link.l1 = "Вы правы, черт возьми... Я... ну, это... опоздал"+ GetSexPhrase("","а") +" к острову. Он, видимо, уже ушёл оттуда, так как я никого не наш"+ GetSexPhrase("ёл","ла") +". Весь путь пришлось идти в бейдевинд - постоянно дул встречный ветер, будь он неладен...";
		...
		case "Pinas_lose":
		dialog.text = "Ну что, " + GetFullName(pchar) + ", как прошла операция? Судя по вашему унылому виду, вы её провалили.";
			link.l1 = "Вы правы, черт возьми... Я... ну, это... опоздал"+ GetSexPhrase("","а") +". Задержал"+ GetSexPhrase("ся","ась") +" в таверне, а когда выш"+ GetSexPhrase("ел","ла") +" в море - уже никого не наш"+ GetSexPhrase("ёл","ла") +".";
			link.l1.go = "Takeslaves_5_lose";
		break;
		...
		case "Slaveshore_5":
			...
			link.l1 = "Ладно, вижу, что не врешь. На твое счастье капитан пинаса перед смертью проболтался, что наши дела раскрыты. Если бы не эта его фраза, я бы уже прикончил"+ GetSexPhrase("","а") +" тебя... Но ты же говорил, чертов денежный мешок, что у тебя здесь на острове всё схвачено!";
