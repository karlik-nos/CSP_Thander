...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		break;
		case "Mushket_1":
			dialog.text = "А как же ты его найдёшь? Он сам по себе, ни на кого не работает, никому долю не платит, в пиратские порты сам не заходит - чтоб делиться не заставили, а в порты колоний его не пускают. Нет, его там, конечно, ждут, чтоб с петлей сосватать, но рисковать не будет - не такой он человек.";
