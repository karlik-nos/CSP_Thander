...
// ============================================================================
	...
	switch(Dialog.CurrentNode)
	{
		...
		break;
		case "BlueBird_3":
			dialog.text = "Ха, это так! Не ты первый, кто на нее целится из Берегового Братства, да вот никто ещё не изловил. Что до меня, то лично мне эта 'птица' не интересна - больно мала для серьезных дел.";
