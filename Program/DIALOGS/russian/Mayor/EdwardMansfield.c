...
// ============================================================================
	switch(Dialog.CurrentNode)
	{
		...
		case "pirateStartQuest_2":
			dialog.text = "Нет, конечно. Разве я похож на идиота? Задаток я не верну в любом случае. Но мне нужны доказательства, что рабы, которых ему подсовывают - это и есть моя партия. А ты просто найдёшь тех, кто предложил ему новую сделку, и получишь свои 10 000 пиастров. Остальное моя забота. Ну что, берешься?";
		...
		case "pirateStartQuest_3":
			dialog.text = "Если бы у меня был хоть намек, я обошёлся бы и без твоих услуг. Они бы уже к ночи ловили кальмаров на живца. Но меня больше интересует другое - как они узнали о грузе 'Сентблу' и о моем заказчике? Уж очень все быстро у них срослось. Смекаешь?";
        ...
        break;
 		...
 		case "Step_H3_5":
			dialog.text = "Не надо пафосных выражений, "+ GetSexPhrase("молодой человек","девушка") +", я знаю, кто я такой. Но я действительно ничего не ведаю о планах Мэдифорда. Однако, вот что я тебе расскажу.\n"+
                          ...
                          "Итого получается, что известный пройдоха Томас Мэдифорд пытался открыть боевые действия против Нидерландов с помощью пиратов. Хитер, что тут ещё скажешь...";
