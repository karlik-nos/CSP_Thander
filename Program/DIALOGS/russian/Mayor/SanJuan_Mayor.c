...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		case "quests":
			...
			{
				link.l1 = "Сеньор губернаор, я капитан " + GetFullName(pchar) + ". Это я венчался в церкви города с вдовой Изабеллой Олеварес, урождённой де Вальдес.";
		...
		break;
		case "Romantic_3":
			dialog.text = "Это мне известно. По приезду из Белиза от своей кузины Фернандес, Изабелла была у меня на приёме и рассказала обо всем этом. Так вы и есть её спаситель?";
			link.l1 = "Да, сеньор губернатор. Полагаю, ничего удивительного нет в том, что мы с Изабеллой решили обвенчаться сразу же, как только это стало возможным. Однако мерзавец Сальватор, ещё до того как погибнуть, нанял целую шайку омерзительного отребья со всего Карибского моря для того, чтобы уничтожить нас.";
			link.l1.go = "Romantic_4";
		break;
		case "Romantic_4":
			dialog.text = "И в церкви были те самые наёмники?";
		...
		break;
		case "Romantic_5":
			dialog.text = "Бесспорно, капитан, так оно и есть. Ну что же, теперь мне все достаточно ясно. Полагаю, мы проведём обряд освещения церкви за общественный счет.";
