...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "Step_F6_2":
			...
			link.l1 = "Так вот, Олоне - мой компаньон, он брал город вместе со мной. И поверьте мне - если вы будете упорствовать, то половина жителей вашего города лишится головы. И отсечёт головы Олоне собственноручно на глазах остальных людей. Как вам такая перспектива?";
        ...
        break;
		case "Step_F6_4":
            dialog.text = "Сеньор"+ GetSexPhrase("","ита") +", совершенно ясно, что мы в вашей власти. Я, как губернатор этого города, совершенно чётко осознаю, в какой ситуации мы находимся. Забирайте все, что найдёте, но денег, за которыми вы сюда пришли, здесь уже нет. Вы опоздали...";
