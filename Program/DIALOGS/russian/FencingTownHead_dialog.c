			...
			switch(sti(PChar.Arena.Tournament.Win))
			{
				...
				case 1:
					...
					if (sti(pchar.questTemp.tournamentcount) == 3 && nopirate)
					{
						...
						dialog.text = dialog.text + "\nТак как вы стали уже трёхкратным победителем турнира, мы решили приготовить кое-что особенное... Это будет карта сокровищ, что по слухам, принадлежала знаменитому "+type+". Полагаю, вам будет по силам разыскать то, что спрятал этот злодей.";
