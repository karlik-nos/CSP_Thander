...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		break;
		case "BlueBird_4":
			dialog.text = "Начнём с того, как этот мерзавец забрал у меня магазин. Он лишил меня поступлений товаров, даже местные пираты ничего мне не продавали, он скупал у них все!";
		...
		break;
		case "BlueBird_9":
			dialog.text = "Ну вот, значит ход моих рассуждений верен... Ты знаешь, на Бермудах есть подземный ход, ведёт из верфи прямо в бухту. В общем, ищи, "+ GetSexPhrase("приятель","подруга") +", да прибудет с тобой сила!";
