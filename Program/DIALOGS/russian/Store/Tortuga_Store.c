...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		break;
 	 	case "Step_H3_1":
			dialog.text = NPCStringReactionRepeat("Был часа два назад, прикупил очередную порцию дорогих безделушек и пошёл дальше жизнь прожигать.", "Сеньор, давайте торговлей займемся, что за одни и те же вопросы?", "Спрашивали вы меня уже о Пьере...", "Послушайте, может вы поспрашиваете о Пьере в другом месте, а?", "block", 0, npchar, Dialog.CurrentNode);
