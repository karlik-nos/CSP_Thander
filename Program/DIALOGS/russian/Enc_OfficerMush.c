void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
        ...
        case "OnceAgain":
            NextDiag.TempNode = "OnceAgain";
			dialog.text = "Вот так встреча, капитан! Вы всё-таки решили усилить свою команду бравым мушкетером?";
		...
		case "exit_Rep":
			...
			dialog.text = "Я никогда не промахиваюсь. Один выстрел – один труп. А то и два, как повезет. Так что не искушай судьбу своими благородными намерениями ещё раз, мушкет заряжен.";
