...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	case "rumours_habitue":
        ...
        {
			dialog.text = "(поет) Я бла-агода-арен виски за свой багро-овый нос, и по-о его-о совету пальто в закла-ад отнес... Эх, наливай, моря"+ GetSexPhrase("к","чка") +"! Я только вчера из рейса, поэтому ещё немного не в себе.";
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		case "rumours_tavern_yes":
            ...
            else
            {
    			...
    			link.l1 = RandPhraseSimple("Благодарю, вот твое золото. А больше ничего не припомнишь?", "Хорошо, ты заслужил свои деньги - держи. Есть что-нибудь ещё?");
...
//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		...
		break;
		case "RBlueBird_6":
			dialog.text = "Вы не ограничены во времени. Я прекрасно понимаю, что сделать это будет нелегко, чёрт возьми! Сказать по правде, мы уже привлекали наемных убийц к этому делу, хотели убрать капитана. Безрезультатно...";
