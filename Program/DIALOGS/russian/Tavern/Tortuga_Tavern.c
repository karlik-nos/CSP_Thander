...
//============================ Голл. линейка, квест №7. узнаем о ожидающем ГГ челе =======================
        ...
        break;
  	 	case "Step_H7_3":
			dialog.text = "Появился он здесь позавчера, сразу сказал, что ждет одного человека. Интересовался кораблями из Кюрасао. Выходит, тебя и ждал. А куда он ушёл - мне неведомо.";
...
//============================ Голл. линейка, квест №8. узнаем о Лоране де Графе =======================
  	 	case "Step_H8_1":
			dialog.text = "На Тортуге ты сейчас его не найдешь. Пару недель назад он ушёл из города. Опять, небось, испанцев потрошить...";
...
//============================ Исп. линейка, квест №3. узнаем о Роке Бразильце =======================
        ...
        break;
  	 	case "Step_S3_2":
			dialog.text = "Тогда это проблема. Рок ушёл в поиск к Маракайбо на своем корвете, будет курсировать рядом, пока не подловит галеон с приличной добычей.";
...
//============================ Испанская линейка, квест №4. узнаем о донне Анне. =======================
        ...
        break;
  	 	case "Step_S4_4":
			dialog.text = "Не-е-ет, здесь обоюдное чувство. Донна Анна так же любит нашего генерал-губернатора, как и он её. Слышал я, что они познакомились ещё в Старом Свете. Привез её на Тортугу один из доверенных офицеров генерал-губернатора - Анри д'Эстре, а где он её нашёл - никто не знает.";
