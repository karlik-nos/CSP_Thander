...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		break;
		case "PL_Q7_3":
			dialog.text = "Не знаю, "+ GetSexPhrase("сам","сама") +" решай. У Соукинса репутация удачливого кэпа. Но лично я бы пошёл с ним, уж больно Ричард готовится к этому тщательно - целыми днями сидит в резиденции и строчит в своем журнале чего-то...";
