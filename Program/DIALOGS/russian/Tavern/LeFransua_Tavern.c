...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		case "barmen_history_7":
			dialog.text = "Да. Хотя на деле он ещё больше – ведь у многих есть свои корабли с полными командами отчаянных головорезов, а один из них – его имя вам пока ничего не скажет – и вовсе является персоной, приближенной к властям, с очень и очень серьезными связями. Но, повторюсь, их можно изловить поодиночке\nОни постоянно перемещаются по Карибам, так что выследить их не самое простое занятие. Но в моей таверне много моряков и много рома, а это значит - что у меня много пьяных болтливых моряков, хе-хе... Так что я смогу кое в чём вам помочь.";
		...
		case "Givetaskhunt_3":
			dialog.text = "Рад вас видеть, " + pchar.name + ". Следующее дело опасное как ни крути. Причем, здесь придётся действовать больше хитростью, нежели шпагой.";
