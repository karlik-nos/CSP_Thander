...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    switch (Dialog.CurrentNode)
	{
		...
		break;
		case "MCTavernMar_1":
			dialog.text = "Маракайбо? У нас, как видите, все в порядке. Есть, правда, ещё Дес-Мойнес, но это такое захолустье, что там никогда ничего не случается. Хотя странно – обычно у меня в таверне толчется два-три рыбака оттуда, а тут давно никто не появлялся.";
