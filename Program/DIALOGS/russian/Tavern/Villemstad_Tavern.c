...
//*************************** ГПК, Мастер Ключей ***************************
		...
		break;
		case "TizerFind_4":
			dialog.text = "Жаль, хороший был человек, хоть и бродяга. Знаешь, бывают люди с обостренным чувством справделивости. Вот Тизер был из таких, да ещё жизнь его изрядно побила. Рассказы об Острове Справедливости были его любимой темой.";
		...
		//ОЗГ, Хален
		case "Halen_tavern_1":
			dialog.text = "Нет, его сейчас здесь нет. Он ушёл в плавание, но вернется со дня на день. Можете остановиться у меня. Когда он вернется - я вам сообщу.";
