    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "MCLiz_4":
			dialog.text = "Ну, об этом особо распространяться не принято, но вам я расскажу.\n"+
				"Слышали вы о капитане Стейтоне? Нет? Хо-хо, тогда знайте, что капитан Стейтон, один из первых флибустьеров, и есть отец Лиз. В свое время, когда он был ещё жив, капитан много сделал для развития города, так что жители Невиса ему обязаны.";
