...
void ProcessDialogEvent()
{
	...
	//================================================================================================================
		...
		case "healthAdd_3":
			...
			{
                dialog.text = ""+ GetSexPhrase("Сын мой","Дочь моя") +", я уже молюсь о твоем благополучии. Молитвы займут все моё время до конца месяца.";
		...
		case "Prison_Cell_Talk_2":
			dialog.text = "Так ты ещё и главарь преступников? И просишь меня пособничать твоим коварным планам? Не бывать этому! Я немедля буду настаивать на твоем приговоре.";
