...
void ProcessDialogEvent()
{
	...
	switch(Dialog.CurrentNode)
	{
		...
		case "PKM_BlackFregat":
			dialog.text = "Чёрный фрегат? А названия у корабля нет? Как я по-вашему должен ответить, если в моём документе указаны все корабли с их названием, а не с цветом корпуса. Я не могу ничего больше вам сказать.";
