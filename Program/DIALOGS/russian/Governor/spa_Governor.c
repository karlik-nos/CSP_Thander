...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        ...
        case "Step_4_19":
            ...
            link.l1 = "Понятно. Ну что же, это, собственно, уже не моё дело. Сеньор генерал-губернатор, я могу считать расследование завершенным?";
...
//********************** Квест №9, Четыре золотых галеона. ************************
        ...
        break;
		case "Step_9_8":
            dialog.text = "Чёрт возьми!!! Как же такое могло случиться?! Я понимаю, что вы оказались в тяжелейшей ситуации, но вы могли бы быть более расторопн"+ GetSexPhrase("ым","ой") +". А сейчас мне нужно отчитываться в Мадриде за серьезную недостачу в поставках золота... И это тогда, когда Испания ведет изнурительную борьбу в Европе!";
