...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
			...
			switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                ...
                case "Albermal_good_time":                  // Геймер успел доставить Альбермаля за неделю.
                    dialog.text = "В доставленном вами письме герцог Альбермаль дает вам весьма лестную оценку. Герцог - мой родственник, именно ему я обязан назначением на эту должность. Если бы не его активные и своевременные действия в Англии, не известно, чем бы закончилось моё губернаторство на Барбадосе...\n"+
        ...
        case "Step_9_4":
            dialog.text = "Чёрт возьми, вы действительно незаменимый человек, " + pchar.name + ". Мэнсфилд отомщен на славу!";
