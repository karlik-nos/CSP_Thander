...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        ...
        case "Step_2_1":
            dialog.text = "В Европе идет торговая война с Голландией. Англо-франкский флот подошёл к берегам Голландии, но, к величайшему удивлению, был разгромлен. Сейчас, по приказу правительства Англии, я должен организовать нападение на голландскую колонию Кюрасао.\n"+
