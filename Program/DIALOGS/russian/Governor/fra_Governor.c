...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
	...
	switch (Dialog.CurrentNode)
	{
		...
		case "work_1":  // работа на благо короны - линейка нации
        	...
        	switch (pchar.questTemp.State)   // что делаем в данный момент
            {
                case "empty":   // Нет взятых квестов
                    ...
                    else
                    {
						switch(pchar.questTemp.CurQuestNumber)   // Взятие квестов начиная со второго
                        {
                            ...
                            break;
                            case "5":
                                dialog.text = "Судар"+ GetSexPhrase("ь","ыня") +", для вас снова поручение деликатного свойства. У меня есть серьезные опасения за жизнь донны де Лейва. Навестите её, пожалуйста, она сейчас у меня в резиденции в соседней комнате. Сеньора посвятит вас в подробности.";
                ...
                case "Fr1Legran_backGovernor":
                    dialog.text = "Месье Легран сумел мне сообщить, что с ним всё в порядке. Кстати, он очень лестно о вас отозвался. Я рад, что не ошибся в выборе честного и надежного человека.";
        ...
        break;
        case "Step_3_4":
            dialog.text = "Значит, вы беретесь за это дело? Отлично! Дама, о которой я говорю, - супруга дона Хосе Рамиреса де Лейва, коменданта Гаваны. Вам надлежит проникнуть в город и найти способ вывести её оттуда.\n"+
