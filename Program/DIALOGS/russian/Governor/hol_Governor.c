...
void ProcessCommonDialogEvent(ref NPChar, aref Link, aref NextDiag)
{
    ...
    switch (Dialog.CurrentNode)
	{
        ...
        break;
        case "Step_4_2":
            dialog.text = "Чёрт возьми! Мы не смогли защитить граждан Республики Соединенных Провинций от кровожадных англичан. Это очень плохо, наше и без того скромное присутствие в Карибском регионе теперь совершенно ослаблено.";
        ...
        break;
        case "Step_9_7":
            dialog.text = "Потому что там идёт активное противостояние с Португалией. И именно сейчас в действиях португальцев наметился определенный успех. Полагаю, что данная эскадра восстановит паритет.";
