...
// Morning1 9 часов
	...
	Weathers[n].Fog.Enable = true;
	Weathers[n].Fog.Height = 500;
	Weathers[n].Fog.Start = 6;
	Weathers[n].Fog.Density = 0.0005;
	Weathers[n].Fog.IslandDensity = 0.00075;
	Weathers[n].Fog.SeaDensity = 0.00075;
