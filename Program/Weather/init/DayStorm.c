...
// Вечерний шторм
	...
	Weathers[n].Fog.IslandDensity = 0.012;
	Weathers[n].Fog.SeaDensity = 0.012;
	...
	Weathers[n].Sea2.BumpScale = 0.05; //МЕЛКИЕ ВОЛНЫ
	Weathers[n].Sea2.PosShift = 4.0; //остроконечность волн
	
	Weathers[n].Sea2.WaterColor = argb(0,0,0,10);
	Weathers[n].Sea2.SkyColor = argb(0, 155, 155, 155);
	...
	Weathers[n].Sea2.Amp1 = 220.0; //амплитуда 1 волны
	Weathers[n].Sea2.AnimSpeed1 = 1.5; //скорость анимации
	Weathers[n].Sea2.Scale1 = 0.045; //размеры волны
	Weathers[n].Sea2.MoveSpeed1 = "9.0, 0.0, 0.0"; //скорость движения

	Weathers[n].Sea2.Amp2 = 8.0;
	Weathers[n].Sea2.AnimSpeed2 = 8.0;
	Weathers[n].Sea2.Scale2 = 0.6;
	...
	Weathers[n].Sea2.FoamV = 70.0;//высота с которой начинается пена
	Weathers[n].Sea2.FoamUV = 0.1; //тайлинг пены
