...
void spawnToughSkeleton(aref _location)
{
	...
	if (drand(100) < 16 && CheckAttribute(_location, "locators.monsters") && !bMonstersGen && _location.type == "cave" && !CheckAttribute(pchar, "cursed.waitingSkull") && pchar.rank >= 3 && pchar.sex != "skeleton")
	{
