...
int LocationInitStLucia(int n)
{
	...
	locations[n].reload.l1.go = "StLucia_Jungle_01";
	...
	// Джунгли
	//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	locations[n].id = "StLucia_Jungle_01";
	...
	locations[n].reload.l3.go = "StLucia_CaveEntrance";
	...
	locations[n].reload.l2.name = "reload2_back";
	locations[n].reload.l2.go = "StLucia_Jungle_01";
